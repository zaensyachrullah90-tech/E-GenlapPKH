...
import { 
  ...
  CheckCircle2, XCircle, User, LogOut 
} from 'lucide-react';
...
// --- IMPORTS MODULAR ---
// =========================================================================
import { DEFAULT_MASTER_RHK_DATA, getFilteredRhk, getBulanFolder } from './utils/constants.js';
...
// =========================================================================
// --- FIREBASE CONFIGURATION (SECURE VIA VERCEL .ENV) ---
// =========================================================================
let envConfig = {};
try {
  // @ts-ignore
    ...
    <div className="min-h-screen bg-slate-50 font-sans text-slate-800 selection:bg-blue-200 selection:text-blue-900 pb-24 md:pb-0 flex justify-center md:justify-start">
      ...
      <div className={`w-full ${isLoggedIn ? 'md:ml-72' : ''} flex flex-col min-h-screen mx-auto bg-slate-50 relative z-10 max-w-md md:max-w-4xl`}>
        ...
        <main className={`flex-grow ${!isLoggedIn ? 'p-0 w-full overflow-hidden' : 'p-5 md:p-8 w-full'}`}>
          ...
          {isLoggedIn && view === 'engine' && <EngineView profile={profile} tokens={tokens} role={role} setTokens={setTokens} showLoading={showLoading} showToast={showToast} reports={reports} setReports={setReports} masterRhk={masterRhk} setView={setView} getBulanFolder={getBulanFolder} auth={auth} db={db} />}
